...
class Mesa
{
    ...
    public function crearMesa()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO mesa (estado_mesa,importe,tipoComentario,comentario,activo) VALUES (:estado_mesa,:importe,:tipoComentario,:comentario,1)");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id_mesa,estado_mesa,importe,tipoComentario,comentario,activo FROM Mesa WHERE activo > 0");
        $consulta->execute();
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id_mesa,estado_mesa,importe,tipoComentario,comentario,activo  FROM Mesa WHERE id_mesa = :id_mesa");
    ...
    public static function modificarMesa($Pedido)
    {
        ...
        $consulta = $objAccesoDato->prepararConsulta("UPDATE Mesa SET estado_mesa = :estado_mesa, importe = :importe, tipoComentario = :tipoComentario , comentario = :comentario WHERE id_mesa = :id");
